        ...
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <div class="logo-main">
                <div class="logo-normal">
                    ...
                    <img src="{{ asset('storage/logos/' . optional(App\Models\Setting::first())->logo) }}" alt="Logo" style="max-width: 80px;">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @if(Permission::hasAccess($userLevel, 'item'))
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{route('BarangMasuk')}}">
                                ...
                                <span class="item-name">Barang Masuk</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{route('BarangKeluar')}}">
                                ...
                                <span class="item-name">Barang Keluar</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-nav collapse" id="sidebar-special2" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="{{route('data')}}">
                                ...
                                <i class="sidenav-mini-icon"> B </i>
                                <span class="item-name">Keuntungan Kerugian</span>
                            </a>
                        </li>
                        <li class="nav-item">
